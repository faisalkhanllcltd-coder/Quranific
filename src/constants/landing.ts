...
export const LANDING_PAGES: Record<AudienceSlug, LandingCopy> = {
  kids: {
    ...
    heroSubtitle:
      'Certified teachers who make learning the Quran fun, interactive, and safe for your children.',
    benefits: [
  ...
  ladies: {
    ...
    heroSubtitle:
      'Learn comfortably with certified, experienced female Quran tutors in a secure environment.',
